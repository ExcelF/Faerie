...
SOURCEFILES := src/faerie_core/faerie_ears.cpp src/faerie_core/faerie_main.cpp src/wifi_connection_monitor/wifi_connection_monitor.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/faerie_ears.o : src/faerie_core/faerie_ears.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/faerie_main.o : src/faerie_core/faerie_main.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/wifi_connection_monitor.o : src/wifi_connection_monitor/wifi_connection_monitor.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
